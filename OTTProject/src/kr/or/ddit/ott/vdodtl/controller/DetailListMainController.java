...
@WebServlet("/main/detail.do")
public class DetailListMainController extends HttpServlet {
	@Override
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		req.getRequestDispatcher("/view/vdodtl/detailListMain.jsp").forward(req, resp);
	}
